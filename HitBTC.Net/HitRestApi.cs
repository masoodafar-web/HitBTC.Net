...
namespace HitBTC.Net
{
    public class HitRestApi
    {
        ...
        /// <param name="cancellationToken">Token for cancel operation</param>
        /// <returns></returns>
        public async Task<HitResponse<HitOrder>> CreateNewOrderAsync(string symbol, HitSide side, HitOrderType type, decimal quantity, decimal price = -1, string clientOrderId = null, decimal stopPrice = -1,
            HitTimeInForce timeInForce = HitTimeInForce.Day, DateTime expireTime = default, bool strictValidate = true, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">Token for cancel operation</param>
        /// <returns></returns>
        public async Task<HitResponse<HitOrder[]>> GetMarginAccountBySymbolAsync(string symbol = null, CancellationToken cancellationToken = default) =>
            await this.MakeRequestAuthorizedAsync<HitOrder[]>(
                HttpMethod.Get,
                cancellationToken,
                "margin/account",
